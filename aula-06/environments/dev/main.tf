# =============================================================================
# Ambiente: dev
# Região:   us-east-1 | CIDR: 10.0.0.0/16
# Instâncias menores e configurações simplificadas para desenvolvimento
# =============================================================================
...
module "api_sg" {
  ...
  ingress_rules = [
    ...
    },
    {
      ...
      to_port         = 22
      protocol        = "tcp"
      cidr_blocks     = ["0.0.0.0/0"] # restringir para IP do desenvolvedor em produção
      security_groups = []
    }
  ]
}
